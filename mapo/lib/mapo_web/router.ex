defmodule MapoWeb.Router do
  use MapoWeb, :router

  import MapoWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {MapoWeb.Layouts, :root}
  ...
  # scope "/api", MapoWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:mapo, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MapoWeb.Telemetry
  ...
  scope "/", MapoWeb do
    ...
    live_session :current_user,
      on_mount: [{MapoWeb.UserAuth, :mount_current_scope}] do
